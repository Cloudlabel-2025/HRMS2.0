                      ...
                      <td style={{ fontSize: 12 }}>
                        {emp.firstLoginAt ? (
                          <span style={{ color: '#16a34a', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 4 }}>
                            ...
                            {formatDateTime(emp.firstLoginAt)}
                          </span>
                        ) : (
